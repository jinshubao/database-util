...
public class TableActionEventHandlerImpl implements TableActionEventHandler {

    private final TabPane tabPane;

    private final DataTableActionEventHandler dataTableActionEventHandler;

    public TableActionEventHandlerImpl(TabPane tabPane, DataTableActionEventHandler dataTableActionEventHandler) {
