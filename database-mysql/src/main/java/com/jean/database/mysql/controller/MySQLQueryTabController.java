...
import com.jean.database.mysql.ExecuteStatus;
...
public class MySQLQueryTabController extends AbstractController implements Initializable {
    ...
    public MySQLQueryTabController(ApplicationContext context, List<String> catalogs, String catalog) {
        super(context);
